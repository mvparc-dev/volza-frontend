...
import { useSearchBuyers, useFilterOptions } from '@/hooks/api/search';
...
export default function BuyersSearchPage() {
  ...
  const { data: searchResults, isLoading, error } = useSearchBuyers(filters, page, 20);
  const { data: filterOptions } = useFilterOptions('buyers');
      ...
      <div className="bg-white shadow-sm rounded-lg p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-600">Discover potential buyers for your products</p>
            </div>
          </div>
          <Button
            variant="outline"
        ...
        <form onSubmit={handleSearch} className="flex gap-4">
          <div className="flex-1">
            <Input
              type="text"
              placeholder="Search for buyers, companies, or industries..."
              value={filters.query || ''}
      ...
      <div className="space-y-4">
        {isLoading && (
          <div className="text-center py-8">
            ...
            <p className="mt-2 text-gray-600">Searching buyers...</p>
          </div>
        )}
          ...
          <>
            <div className="flex items-center justify-between">
              <p className="text-sm text-gray-600">
                Found {searchResults.pagination.total} buyers
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {searchResults.data.map((buyer: any) => (
